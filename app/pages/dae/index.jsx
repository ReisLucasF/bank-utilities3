...
const daeDafReceiptConfig = {
  ...
  extractFields: [
    ...
    { id: "docDae", label: "Nº do Documento DAE" },
  ...
  // Template HTML para o comprovante DAE-DAF (DARF)
  receiptTemplate: `
    <!DOCTYPE html>
    <html lang="pt-BR">
      <head>
  ...
  customExtractors: {
    ...
    // Extrator para o número do documento DAE
    docDae: (textContent) => {
...
// Componente que renderiza o gerador de comprovante de DAE-DAF (DARF)
const DAEDAFReceiptGenerator = () => {
  return <CustomizableReceiptGenerator config={daeDafReceiptConfig} />;
};

export default DAEDAFReceiptGenerator;
