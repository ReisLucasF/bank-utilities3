...
const CardCreator = () => {
  ...
  const [corTitulo, setCorTitulo] = useState("#1526FF");
  const [subtitulo, setSubtitulo] = useState("Escreva um subtítulo");
  const [corSubtitulo, setCorSubtitulo] = useState("#1526FF");
  const [textoCTA, setTextoCTA] = useState("Escreva a CTA");
  const [corTextoCTA, setCorTextoCTA] = useState("#FFFFFF");
  const [corFundoCTA, setCorFundoCTA] = useState("#1526FF");
  const [corBordaCTA, setCorBordaCTA] = useState("#1526FF");
  const [corInicio, setCorInicio] = useState("#E1E2E0");
  const [corFim, setCorFim] = useState("#E1E2E0");
